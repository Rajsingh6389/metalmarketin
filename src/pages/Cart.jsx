                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <input
                          ...
                          className="w-16 text-center bg-gray-800 rounded p-1 text-white outline-none border border-gray-700 focus:border-primary"
                        />
            ...
            <div className="mt-6 bg-gray-900 p-4 rounded-xl flex justify-between items-center  hover:shadow-pink">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-primary text-dark rounded-lg hover:bg-accent transition-all"
                >
                  Checkout
                </button>
              </div>
