...
export default function Home() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-gradient-to-b from-[#0f0f0f] via-[#111111] to-[#1a1a1d]">
      {/* Header */}
      <div className="text-center py-12 px-4">
        <h1 className="text-4xl md:text-5xl font-extrabold text-white drop-shadow-lg"> <marquee behavior="scroll" direction="left" scrollamount="10"> Welcome to MetalMarket </marquee> </h1>
